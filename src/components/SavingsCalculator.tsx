        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6 md:gap-10">
            ...
            <StaggeredText delay={200}>
              <div className="bg-[rgba(248,244,235,0.4)] backdrop-blur-sm border-[2px] border-[rgb(64,64,64)] p-5 md:p-8 transition-all duration-300 hover:border-[rgb(120,95,50)]/80">
                <div className="flex items-center gap-3 mb-6 md:mb-8">
                  <div className="w-10 h-10 border-[2px] border-[rgb(64,64,64)] bg-[rgba(248,244,235,0.5)] flex items-center justify-center group icon-pulse-hover">
            ...
            <StaggeredText delay={400} className="flex flex-col gap-4">
              ...
              {/* Time Saved */}
              <div className="bg-[rgba(248,244,235,0.4)] backdrop-blur-sm border-[2px] border-[rgb(64,64,64)] p-4 md:p-5 hover:border-[rgb(120,95,50)]/80 transition-all duration-300 group">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 border-[2px] border-[rgb(64,64,64)] bg-[rgba(248,244,235,0.5)] flex items-center justify-center shrink-0 group-hover:border-[rgb(120,95,50)]/80 group-hover:bg-[rgba(120,95,50,0.08)] transition-all duration-300">
