          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-10">
            ...
            <div className="card-brutal p-5 md:p-8">
              <div className="flex items-center gap-3 mb-6 md:mb-8">
                <div className="w-10 h-10 border-2 border-primary bg-primary/20 flex items-center justify-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Time Saved */}
              <div className="card-brutal p-4 md:p-5 hover:border-secondary transition-colors duration-150">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 border-2 border-secondary bg-secondary/20 flex items-center justify-center shrink-0">
